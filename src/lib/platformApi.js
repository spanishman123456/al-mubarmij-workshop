...
export async function fetchTeacherDay07AnswersApi() {
  return request("/api/teacher/day-07-answers");
}

export async function fetchTeacherDay08AnswersApi() {
  return request("/api/teacher/day-08-answers");
}

export async function fetchTeacherDay09AnswersApi() {
  return request("/api/teacher/day-09-answers");
}

export async function fetchTeacherDay10AnswersApi() {
  return request("/api/teacher/day-10-answers");
}

export async function fetchTeacherDay11AnswersApi() {
  return request("/api/teacher/day-11-answers");
}

export async function fetchTeacherDay12AnswersApi() {
  return request("/api/teacher/day-12-answers");
}
...
export async function fetchTeacherDay15AnswersApi() {
  return request("/api/teacher/day-15-answers");
}
