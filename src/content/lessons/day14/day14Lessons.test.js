...
import { projectArchitectureLesson } from "./projectArchitectureLesson.js";
import { projectImplementationLesson } from "./projectImplementationLesson.js";
import { projectTestingLesson } from "./projectTestingLesson.js";
import { projectPresentationLesson } from "./projectPresentationLesson.js";

const LESSONS = [
  projectArchitectureLesson,
  projectImplementationLesson,
  projectTestingLesson,
  projectPresentationLesson,
];

describe("day14 lesson depth", () => {
  it("keeps all day14 lessons structurally complete", () => {
