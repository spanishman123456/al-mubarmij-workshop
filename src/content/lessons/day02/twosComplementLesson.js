...
export const twosComplementLesson = {
  ...
  guidedPractice: [
    { id: "g1", promptAr: "مثل العدد −2 في 4-bit signed (مكمل 2).", answer: "1110", hints: ["flip 0010 ثم +1"] },
    { id: "g2", promptAr: "ما قيمة 11111111 في 8-bit signed؟", answer: "-1", hints: ["MSB=1 إذن سالب"] },
  ],
  independentPractice: [
    { id: "i1", promptAr: "مثل العدد −10 بالكامل في 8-bit signed.", answer: "11110110", hints: ["10=00001010 ثم flip+1"] },
    { id: "i2", promptAr: "ما أكبر قيمة موجبة في 4-bit signed؟", answer: "7", hints: ["0111"] },
    { id: "i3", promptAr: "في 3-bit signed: هل 3 + 1 يسبب overflow؟", answer: "نعم", hints: ["المدى هو −4..3"] },
    { id: "i4", promptAr: "في 8-bit signed: ما قيمة 00000101؟", answer: "5", hints: [] },
  ],
