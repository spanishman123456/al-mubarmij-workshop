...
export const ifStatementLesson = {
  ...
  quickCheck: {
    questions: [
      { id: "qc1", promptAr: "ما نتيجة المقارنة التالية؟", expression: "3 > 5", answer: "False", hintAr: "bool" },
      { id: "qc2", promptAr: "== للمقارنة؟", answer: "نعم", hintAr: " = للتعيين، == للمقارنة" },
      { id: "qc3", promptAr: "else ينفّذ عند؟", answer: "فشل if", hintAr: "False" },
      { id: "qc4", promptAr: "ما نتيجة المقارنة التالية؟", expression: "10 >= 10", answer: "True", hintAr: ">=" },
    ],
  },
  guidedPractice: [
    {
      id: "gp1",
      promptAr: "هل الطالب ناجح أم راسب؟",
      expression: "score >= 50",
      values: [{ name: "score", value: "40" }],
      answer: "راسب",
      hints: ["40<50"],
    },
    { id: "gp2", promptAr: "n=9 — زوجي أم فردي؟", answer: "فردي", hints: ["9%2=1"] },
    { id: "gp3", promptAr: "ما نتيجة المقارنة التالية؟", expression: "5 == 5", answer: "True", hints: [] },
  ...
  independentPractice: [
    ...
    {
      id: "ip2",
      promptAr: "هل الطالب ناجح؟",
      expression: "score >= 50",
      values: [{ name: "score", value: "50" }],
      answer: "نعم",
      hints: [">=50"],
    },
    { id: "ip3", promptAr: "ما نتيجة المقارنة التالية؟", expression: "7 != 7", answer: "False", hints: [] },
