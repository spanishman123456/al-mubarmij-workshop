...
import { aiFoundationsLesson } from "./aiFoundationsLesson.js";
import { machineLearningBasicsLesson } from "./machineLearningBasicsLesson.js";
import { aiEthicsSafetyLesson } from "./aiEthicsSafetyLesson.js";
import { aiResearchPresentationLesson } from "./aiResearchPresentationLesson.js";

const LESSONS = [
  aiFoundationsLesson,
  machineLearningBasicsLesson,
  aiEthicsSafetyLesson,
  aiResearchPresentationLesson,
];

describe("day11 lesson depth", () => {
  it("keeps all day11 lessons structurally complete", () => {
