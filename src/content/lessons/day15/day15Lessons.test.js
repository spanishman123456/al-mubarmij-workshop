...
import { finalPresentationLesson } from "./finalPresentationLesson.js";
import { peerFeedbackLesson } from "./peerFeedbackLesson.js";
import { finalEvaluationLesson } from "./finalEvaluationLesson.js";
import { programClosureLesson } from "./programClosureLesson.js";

const LESSONS = [finalPresentationLesson, peerFeedbackLesson, finalEvaluationLesson, programClosureLesson];

describe("day15 lesson depth", () => {
  it("keeps all day15 lessons structurally complete", () => {
