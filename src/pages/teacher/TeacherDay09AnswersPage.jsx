...
import { fetchTeacherDay09AnswersApi } from "../../lib/platformApi";
import { day09TeacherAnswers } from "../../content/teacher/day09TeacherAnswers";
...
export default function TeacherDay09AnswersPage() {
  const [data, setData] = useState(day09TeacherAnswers);

  useEffect(() => {
    let cancelled = false;
    fetchTeacherDay09AnswersApi()
      .then((res) => {
  ...
  return (
    <PageShell title={titleAr} subtitle="للمعلم فقط — pdfPage 403–426">
