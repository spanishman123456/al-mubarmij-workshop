...
import { fetchTeacherDay11AnswersApi } from "../../lib/platformApi";
import { day11TeacherAnswers } from "../../content/teacher/day11TeacherAnswers";
...
export default function TeacherDay11AnswersPage() {
  const [data, setData] = useState(day11TeacherAnswers);

  useEffect(() => {
    let cancelled = false;
    fetchTeacherDay11AnswersApi()
      .then((res) => {
  ...
  return (
    <PageShell title={titleAr} subtitle="للمعلم فقط — day11">
