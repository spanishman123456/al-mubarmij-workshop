...
import { day14TeacherAnswers } from "../../content/teacher/day14TeacherAnswers";
import { fetchTeacherDay14AnswersApi } from "../../lib/platformApi";
...
export default function TeacherDay14AnswersPage() {
  const [data, setData] = useState(day14TeacherAnswers);

  useEffect(() => {
    let cancelled = false;
    fetchTeacherDay14AnswersApi()
      .then((res) => {
  ...
  return (
    <PageShell title={data.titleAr} subtitle="للمعلم فقط — day14">
