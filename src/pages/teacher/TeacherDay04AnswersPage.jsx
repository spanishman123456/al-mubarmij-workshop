...
export default function TeacherDay04AnswersPage() {
  const { titleAr, teacherGuidance, sections } = day04TeacherAnswers;

  return (
    <PageShell title={titleAr} subtitle="للمعلم فقط — pdfPage 190–211">
