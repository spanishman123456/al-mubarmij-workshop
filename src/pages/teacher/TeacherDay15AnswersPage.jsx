...
import { day15TeacherAnswers } from "../../content/teacher/day15TeacherAnswers";
import { fetchTeacherDay15AnswersApi } from "../../lib/platformApi";
...
export default function TeacherDay15AnswersPage() {
  const [data, setData] = useState(day15TeacherAnswers);

  useEffect(() => {
    let cancelled = false;
    fetchTeacherDay15AnswersApi()
      .then((res) => {
  ...
  return (
    <PageShell title={data.titleAr} subtitle="للمعلم فقط — day15">
