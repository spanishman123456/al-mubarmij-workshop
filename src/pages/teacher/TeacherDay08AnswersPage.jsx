...
import { fetchTeacherDay08AnswersApi } from "../../lib/platformApi";
import { day08TeacherAnswers } from "../../content/teacher/day08TeacherAnswers";
...
export default function TeacherDay08AnswersPage() {
  const [data, setData] = useState(day08TeacherAnswers);

  useEffect(() => {
    let cancelled = false;
    fetchTeacherDay08AnswersApi()
      .then((res) => {
  ...
  return (
    <PageShell title={titleAr} subtitle="للمعلم فقط — pdfPage 373–402">
