...
import { day13TeacherAnswers } from "../../content/teacher/day13TeacherAnswers";
import { fetchTeacherDay13AnswersApi } from "../../lib/platformApi";
...
export default function TeacherDay13AnswersPage() {
  const [data, setData] = useState(day13TeacherAnswers);

  useEffect(() => {
    let cancelled = false;
    fetchTeacherDay13AnswersApi()
      .then((res) => {
  ...
  return (
    <PageShell title={data.titleAr} subtitle="للمعلم فقط — day13">
