...
import { fetchTeacherDay10AnswersApi } from "../../lib/platformApi";
import { day10TeacherAnswers } from "../../content/teacher/day10TeacherAnswers";
...
export default function TeacherDay10AnswersPage() {
  const [data, setData] = useState(day10TeacherAnswers);

  useEffect(() => {
    let cancelled = false;
    fetchTeacherDay10AnswersApi()
      .then((res) => {
  ...
  return (
    <PageShell title={titleAr} subtitle="للمعلم فقط — pdfPage day10">
