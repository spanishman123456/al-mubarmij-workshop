...
| `numbers-steps-activity` | 2 | — | — | — | — | — | yes (labs) | NumbersStepsLab | API |
| `collatz` | 2 | 2 | 2 | 2 | 1 | 2 | yes (labs) | CollatzSimulator | API |
| `truth-tables` | 3 | 2 | 2 | 2 | 1 | 2 | yes (labs) | TruthTableBuilder | API |
| `logic-gates` | 4 | 2 | 2 | 2 | 1 | 2 | yes (labs) | LogicGatesSim | API |
